...
ShadowsocksR其它分支：[SSR python manyuser](https://github.com/breakwa11/shadowsocks/tree/manyuser), [SSR-libev](https://github.com/breakwa11/shadowsocks-libev)  
Android APP: [SSR-android](https://github.com/glzjin/shadowsocksr-android/releases)  
